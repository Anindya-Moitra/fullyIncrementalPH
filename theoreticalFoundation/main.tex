...
In this document, we prove that a streaming or incremental version of the standard algorithm exists 
and that it is correct.  In particular, we prove that even when a simplex $\sigma$ that changes the 
