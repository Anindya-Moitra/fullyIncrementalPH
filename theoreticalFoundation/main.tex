...
\begin{proof}
	...
	reduction \cite{kerber-18, bauer-14}.  Since the columns are reduced by left-to-right column 
	additions, the insertion of a new $j$-th column in $R$ does not impact any column $i < j$.
\end{proof}
